...
export const BloodHoundHeading: string = "Blood Hound";
...
export const EnterYourOTP: string = "Please enter your OTP";
export const EnterYourEmailAddress: string = "Please enter your email";
...
export const QrCodeAlertText: string =
  "If your qr code is not working then enter this code in your input field.";
export const ScrollableDropDownMenu: string = "Scrollable Drop Down Menu";
export const Firstname: string = "First name";
