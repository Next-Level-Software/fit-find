...
const ModelNames = {
    ...
    MerchantSubscription: { model: "MerchantSubscription", db: "merchantsubscriptions" },
    MerchantSubscriptionPlan: { model: "MerchantSubscriptionPlan", db: "merchantsubscriptionplans" },
